# Convert raw images and questions into inputs for featurization, to be fed batwise into classifier
    ...
    def __call__(self, raw_batch_dict):
        return {
            ...
            **self.preprocess_images(
                raw_batch_dict["screenshot"]
                if isinstance(raw_batch_dict, dict) else
                [i['screenshot'] for i in raw_batch_dict]
            ),
            'labels': torch.tensor(
